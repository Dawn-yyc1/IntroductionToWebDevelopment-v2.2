...
public class CommentingCode {
    public static void main(String[] args) {
        ...
        //Comments can be on their line
        System.out.println("...");//or they can share like this
        
        //However if you the  BEFORE a line of code
        //System.out.println("Then it is consider a comment");
        //System.out.println("and it won't execute!");
        
        /*
        This is an example of a multi-line comment, which is useful if you want
        to comment out multiple lines of code quickly. 
        Console.WriteLine("Java ignores evergything inside the comment markers.");
        */
